...
def ingest_package_metadata(pkg: dict):
    ...
    try:
        ...
        filepath, record_count = _save("metadata", filename, envelope)
...
def ingest_download_stats_recent(pkg: dict):
    ...
    try:
        ...
        filename = f"{pypi}.json"
        filepath, record_count = _save("downloads_recent", filename, envelope)
...
def ingest_download_stats_overall(pkg: dict):
    ...
    try:
        ...
        filename = f"{pypi}.json"
        filepath, record_count = _save("downloads_overall", filename, envelope)
